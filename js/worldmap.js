    ...
    for (var i = 0; i < data.length; i++) {
      for (var j = 0; j < land.length; j++) {
        ...
        if (data[i].Name_en === land[j].getAttribute("title")) {
          ...
          land[j].setAttribute(
            "class",
            land[j].getAttribute("class") + " infected"
          );
          ...
          if (counter < 1) {
            land[j].setAttribute(
              "class",
              land[j].getAttribute("class") + " low"
            );
          } else if (counter >= 1 && counter < 10000) {
            land[j].setAttribute(
              "class",
              land[j].getAttribute("class") + " middle"
            );
          } else if (counter >= 10000 && counter < 50000) {
            land[j].setAttribute(
              "class",
              land[j].getAttribute("class") + " high"
            );
          } else if (counter >= 50000 && counter < 100000) {
            land[j].setAttribute(
              "class",
              land[j].getAttribute("class") + " veryhigh"
            );
          } else if (counter >= 100000) {
            land[j].setAttribute(
              "class",
              land[j].getAttribute("class") + " highest"
            );
          }
        }
      }
