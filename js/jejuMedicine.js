...
var 마스크판매_우체국 = [
    ...
    },
    {
        ...
        "lat": "33.447358",
        "lng": "126.912258",
        "주소": "제주특별자치도 서귀포시 서성일로 1253 제주특별자치도",
        "전화번호": "064-782-2005",
        "구분": "마스크판매_우체국"
    },
    {
    ...
    },
    {
        ...
        "lat": "33.250147",
        "lng": "126.279540",
        "주소": "제주특별자치도 서귀포시 대정읍 추사로12번길 28",
        "전화번호": "064-794-5005",
        "구분": "마스크판매_우체국"
    },
    {
    ...
    },
    {
        ...
        "lat": "33.543186",
        "lng": "126.661420",
        "주소": "제주특별자치도 서귀포시 안덕면 화순리 1069-5",
        "전화번호": "064-794-9003",
        "구분": "마스크판매_우체국"
    },
    {
...
for(let i in 마스크판매_우체국) {
    ...
    var contentString = [
        ...
        '전화번호 : <a href="tel:', 마스크판매_우체국[i]['전화번호'], '">',
        마스크판매_우체국[i]['전화번호'], '<br>',
        '</p>',
        '</div>'
    ].join('');
