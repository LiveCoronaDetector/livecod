...
for(let i in 지역이름) {
    ...
    for (var c = 0; c < 크롤러_지역별현황.length; c++) {
      if(지역이름[i] == 크롤러_지역별현황[c]['지역이름']){
        크롤러_지역별확진자 = 크롤러_지역별현황[c]['확진자수'];
        크롤러_지역별사망자 = 크롤러_지역별현황[c]['사망자수'];
        크롤러_지역별격리해제 = 크롤러_지역별현황[c]['격리해제수'];
        크롤러_십만명당발생율 = 크롤러_지역별현황[c]['십만명당발생율'];
        크롤러_지역별확진자비율 = 크롤러_지역별현황[c]['지역별확진자비율'];
      }
    }
    // console.log('크롤러')
