(function () {
  ...
  const simulationBtn_30 = document.querySelector(".simulation-btn-30");
  ...
  function checkCount() {
    ...
    if (sickCount === 0 || prevBtn == "simulation-btn-30") {
      stop = true;
    }
  }
  ...
  function chk_btn_click() {
    if (clicked_btn == true) {
      ...
      prevBtn = curBtn;
      curBtn = "simulation-btn-30";

      init();
    }
  }

  simulationBtn_30.addEventListener("click", chk_btn_click);
})();
