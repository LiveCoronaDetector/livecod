(function () {
  ...
  const simulationBtn_80 = document.querySelector(".simulation-btn-60-2time");
  ...
  function checkCount() {
    ...
    if (sickCount === 0 || prevBtn == "simulation-btn-60-2time") {
      stop = true;
    }
  }
  ...
  function chk_btn_click() {
    if (clicked_btn == true) {
      ...
      prevBtn = curBtn;
      curBtn = "simulation-btn-60-2time";
