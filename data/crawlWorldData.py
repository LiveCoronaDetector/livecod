...
def write_data(world_confirmed):
    ...
    # with open(cur_path+"\worldData.js", "w", encoding='UTF-8-sig') as json_file:
    ...
    # with open(cur_path+"\worldData.js", "r", encoding='UTF-8-sig') as f:
        while True:
            line = f.readline()
            if not line: break
            data += line
    ...
    # with open(cur_path+"\worldData.js", "w", encoding='UTF-8-sig') as f_write:
        f_write.write(data)
